...
CREATE TABLE IF NOT EXISTS `pearsonqa`.`respuesta` (
  ...
  `respuesta` VARCHAR(1500) NULL DEFAULT NULL,
  `feedback` VARCHAR(1400) NULL,
...
-- -----------------------------------------------------
-- Table `pearsonqa`.`actividad_tipo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pearsonqa`.`actividad_tipo` (
  `id_actividad_tipo` INT NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(200) NULL DEFAULT NULL,
  `descripcion` VARCHAR(400) NULL,
  `reg_status` VARCHAR(45) NULL DEFAULT NULL,
  `created_by` VARCHAR(200) NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `pearsonqa`.`actividad_categoria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pearsonqa`.`actividad_categoria` (
...
CREATE TABLE IF NOT EXISTS `pearsonqa`.`actividad` (
  ...
  `id_actividad_categoria` INT NOT NULL,
  ...
  CONSTRAINT `fk_actividad_lectura1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_actividad_orden1`
    FOREIGN KEY (`id_actividad_tipo`)
    REFERENCES `pearsonqa`.`actividad_tipo` (`id_actividad_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_actividad_actividad_categoria1`
    FOREIGN KEY (`id_actividad_categoria`)
    REFERENCES `pearsonqa`.`actividad_categoria` (`id_categoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `pearsonqa`.`actividad_pregunta`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pearsonqa`.`actividad_pregunta` (
  `id_actividad_pregunta` INT NOT NULL AUTO_INCREMENT,
  `bateria` INT NULL,
  `reg_status` VARCHAR(45) NULL DEFAULT NULL,
  `created_by` VARCHAR(200) NULL DEFAULT NULL,
  `created_date` DATETIME NULL DEFAULT NULL,
  ...
  `id_pregunta` INT NOT NULL,
  `id_actividad` INT NOT NULL,
  PRIMARY KEY (`id_actividad_pregunta`),
  CONSTRAINT `fk_Lectura_Pregunta_pregunta1`
    FOREIGN KEY (`id_pregunta`)
    REFERENCES `pearsonqa`.`pregunta` (`id_pregunta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_lectura_pregunta_actividad1`
    FOREIGN KEY (`id_actividad`)
    REFERENCES `pearsonqa`.`actividad` (`id_actividad`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
