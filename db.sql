...
-- -----------------------------------------------------
-- Table `pearsonqa`.`sesion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pearsonqa`.`sesion` (
  `id_sesion` INT NOT NULL AUTO_INCREMENT,
  `grado` INT NULL DEFAULT NULL,
  `sesion` INT NULL,
  `bloque` INT NULL,
  `tipo` VARCHAR(45) NULL,
  `tipo_nombre` VARCHAR(200) NULL,
  `reg_status` VARCHAR(45) NULL DEFAULT NULL,
  `created_by` VARCHAR(200) NULL DEFAULT NULL,
  `created_date` DATETIME NULL DEFAULT NULL,
  `last_update_by` VARCHAR(200) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pearsonqa`.`actividad` (
  ...
  CONSTRAINT `fk_actividad_orden1`
    ...
    REFERENCES `pearsonqa`.`sesion` (`id_sesion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
